...
const archive = () => {
  ...
  return (
    <>
      ...
      {/* vebinars-video-section */}
      <section className='simple-section-small pt10'>
        <div className='container'>
          <ul className='vebinars-video-list'>
            <li>
              <div className='vebinars-video-block'>
                <div
                  className='js-lazyYT'
                  data-youtube-id='l6pDOwNeTrg'
                  data-ratio='16:9'
                  data-parameters='enablejsapi=1'
                ></div>
